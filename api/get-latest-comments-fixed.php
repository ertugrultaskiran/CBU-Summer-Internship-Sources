        ...
        if ($isChannelId) {
            ...
            try {
                ...
                foreach ($currentComments as $comment) {
                    ...
                    $comment['video_url'] = 'https://www.youtube.com/watch?v=' . $videoId;
                    $comment['video_view_count'] = 0;
                    $comment['video_like_count'] = 0;
                    $comment['video_published_at'] = date('Y-m-d H:i:s');
                    $comment['channel_id'] = '';
